    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAuditLog", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductAuditLog_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductAuditLog_User_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAuditLog_ChangedByUserId",
                table: "ProductAuditLog",
                column: "ChangedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductAuditLog_ProductId",
                table: "ProductAuditLog",
                column: "ProductId");
